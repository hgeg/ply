...
//    frameData = (GLubyte *) calloc(videoSize.width * videoSize.height * 4, sizeof(GLubyte));
    ...
    if (outputSettings == nil) 
    {
        ...
        [outputSettings setObject:[NSNumber numberWithInt:240] forKey:AVVideoHeightKey];
    }
    ...
    NSDictionary *videoCleanApertureSettings = [NSDictionary dictionaryWithObjectsAndKeys:
                                                ...
                                                [NSNumber numberWithInt:240], AVVideoCleanApertureHeightKey,
    ...
    NSDictionary *videoAspectRatioSettings = [NSDictionary dictionaryWithObjectsAndKeys:
                                              ...
                                              [NSNumber numberWithInt:4], AVVideoPixelAspectRatioVerticalSpacingKey,
                                              nil];
